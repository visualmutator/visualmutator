namespace VisualMutator.Model.Tests.Services
{
    ...
    public class NUnitXmlTestService : ITestService
    {
        ...
        {
            private readonly NUnitXmlTestService _service;
            ...
            public TestsLoadJob(NUnitXmlTestService service, IList<string> assemblies)
            {
                _service = service;
