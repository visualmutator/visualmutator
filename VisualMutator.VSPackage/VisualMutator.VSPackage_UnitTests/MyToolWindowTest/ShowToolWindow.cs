...
using PiotrTrzpil.VisualMutator_VSPackage;

namespace VisualMutator.VSPackage_UnitTests.MyToolWindowTest
{
    [TestClass()]
    public class ShowToolWindowTest
    {
        ...
        {
            IVsPackage package = new VisualMutator_VSPackagePackage() as IVsPackage;
            ...
            MethodInfo method = typeof(VisualMutator_VSPackagePackage).GetMethod("ShowToolWindow", BindingFlags.NonPublic | BindingFlags.Instance);
